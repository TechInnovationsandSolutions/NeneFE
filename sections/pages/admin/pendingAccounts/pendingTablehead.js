...
const PendingTablehead = ({tableData, setTableData, setSelected, allLists, setAllSelected}) => {
        ...
        <tr className='text-xs sm:text-sm font-bold text-[#757575] border-b w-full'>
          ...
          <th className='text-left py-5 px-4'>
            <div className='flex gap-2'>
              <p>DATE APPLIED</p>
              <Image src={arrowdownup} width={15} onClick={e => sortPrice(tableData)} alt='filter by date' />
            </div>
          </th>
        </tr>
      </thead>
