...
function ApprovedTableRow({currentItems, setSelected,allSelected}) {
    ...
    <>
      ...
      {currentItems && currentItems.map((cell, i) => (
        <tr className='text-sm sm:text-base font-normal hover:bg-[#F6F6F6]' key={i}>
          <ChecboxApprovedbox setSelected={setSelected} cell={cell} currentItems={currentItems} allSelected={allSelected} />
