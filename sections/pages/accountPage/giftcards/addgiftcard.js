  ...
  return (
    <div className="flex flex-col gap-8 w-full-h-auto">
      ...
      <div className="flex flex-col px-10 py-[30px] gap-3 w-full bg-white">
        <h3 className="text-xl text-black font-bold">Add Gift Card</h3>
        <p className="text-base max-w-[90%]">
          Enter long number and scratch the panel at the back of your card to
          reveal the pin.
        </p>
        <form className="flex flex-col gap-3">
          ...
          <label htmlFor="sub digit" className="flex flex-col gap-3">
            4 Digit Pin
            <input
              id="sub digit"
              type="text"
