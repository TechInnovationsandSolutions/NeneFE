...
import ProductInfo from "@/sections/pages/productPage/productInfo";
import ProductModal from "@/sections/pages/productPage/productModal";
import RelatedProduct from "@/sections/pages/productPage/relatedProduct";
...
function Product() {
  ...
  return (
    <article className='text-lg mx-[30px] lg:mx-24 font-sans font-[400]'>
      ...
      />
      <p className='max-w-[650px] m-auto mt-9 mb-16'>
        <span className='text-[#7D7878]'>Home / Clothes / Dresses /</span> Zara
        Twist Front Textured Slinky Ruched Midi Dress{" "}
      </p>
      <ProductInfo
        currentPic={currentPic}
