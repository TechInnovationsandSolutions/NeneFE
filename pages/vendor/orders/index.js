  ...
  return (
    <article>
      <div className='flex flex-col md:flex-row justify-between gap-3 md:items-center mt-8 mb-10 px-6'>
        ...
        <div className='py-3 px-5 flex border justify-center border-[#AAAAAA] relative gap-3 cursor-pointer'  >
          <p>{period}</p>
          <Image src={chevronDown} onClick={showDecision}/>
            <div className={`absolute -right-3 -bottom-36 ${show ? 'flex' : 'hidden'} flex-col shadow-md border text-sm bg-white w-44 text-center py-2`}>
