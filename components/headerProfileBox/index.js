        ...
        <div className="absolute z-[11] bg-white text-[.8em] -left-[3em] w-[200px] text-black py-1 px-2 top-[3em]">
          <div className="flex justify-between py-2 border-b border-[#D7D7D7]">
            <button
              ...
              className="border-transparent hover:border-b border-b-[#757575]"
            >
              Sign In
            </button>
            <button
          ...
          <div
            class="absolute -top-1 left-10 h-[10px] transform rotate-45  w-0  border border-solid border-turquoise border-l-transparent border-r-transparent z-20"
